  ...
  return (
    ...
    <div>
      ...
      {blogs.map((blog, i) => (
        <div
          key={i}
          className="flex items-center gap-5 py-3 border-b border-b-red-500"
        >
      ...
      >
        <div>
          ...
          <p className="text-sm">
          Please contact us via phone or email given below. We will try to provide a solution as soon as possible.
          </p>
        </div>
        <div>
          ...
          <a className="" href="mailto:shipatulhasan328@gmail.com">shipatulhasan328@gmail.com</a>
          </div>
        </div>
      </div>
      </div>
