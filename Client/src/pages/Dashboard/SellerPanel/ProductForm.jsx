        ...
        <div className="w-full max-w-md p-8 space-y-3 text-gray-800 rounded-xl bg-gray-50">
          ...
          >
            <div className="space-y-1 text-sm">
              ...
              />
              {errors.title && (
                <p className="my-2 p-2 bg-red-200 font-bold text-[#EFCF4F]">
            ...
            <div className="md:flex justify-between gap-2">
              ...
              <div className="space-y-1 text-sm">
                ...
                <input
                  className="w-full px-4 py-3 text-gray-800 border border-[#EFCF4F] focus:outline-[#EFCF4F] rounded "
                  {...register("sellprice", {
                    required: "sellprice is required",
                  })}
                  id="sellprice"
                  type="number"
            ...
            <div className="space-y-1 text-sm">
              ...
              <textarea
                ...
                id="description"
                className="block rounded focus:green-300 w-full h-20 px-4 py-3 text-gray-800  border border-[#EFCF4F] focus:outline-[#EFCF4F] "
              ></textarea>
              {errors.description && (
                <p className="my-2 p-2 bg-red-200 font-bold text-[#EFCF4F]">
