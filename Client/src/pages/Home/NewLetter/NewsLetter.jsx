    ...
    <div className="flex flex-col items-center justify-center max-w-2xl px-4 py-10 mx-auto sm:max-w-xl md:max-w-2xl lg:py-10 md:px-8">
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <p className="text-sm text-gray-700 md:text-lg">
          The best resale bike shop in town. You can get and sell your bike at
          an affordable price.
        </p>
      </div>
      ...
      <p className="max-w-md mb-10 text-xs text-gray-600 sm:text-sm md:text-center">
        We have so much trusted seller here. So you will get the fresh condition
        bike for sure. Best of of luck for your deal. Stay with us.
      </p>
    </div>
  );
};
