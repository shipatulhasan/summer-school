...
const ErrorPage = () => {
  ...
  return (
    <section
      className="flex items-center h-full min-h-screen p-4 dark:bg-gray-900 dark:text-gray-100 bg-center bg-no-repeat bg-cover"
      style={{ backgroundImage: `url(${img})` }}
    >
      <Helmet>
        <title>404 - Music School</title>
      </Helmet>
      <div className="container flex items-center justify-center w-full md:w-1/2  px-5 mx-auto py-8 bg-white bg-opacity-60 rounded-sm shadow-xl shadow-slate-200">
        <div className="md:max-w-lg text-center">
          ...
          <div className="text-center">
            <Link
              to="/"
              className="text-red-700 bg-red-200 rounded px-8 py-3 hover:cursor-pointer gap-2 font-bold"
            >
              Back to homepage
            </Link>
          </div>
